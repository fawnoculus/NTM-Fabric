...
public class GeigerCounterRender {
  private static final Identifier TEXTURE = NTM.id("textures/gui/geiger_counter.png");
  ...
  public static void drawGeigerCounter(DrawContext context, RenderTickCounter tickCounter) {
    ...
    if(incomingMilliRads > 0){
      ...
      Text text = Text.translatable("generic.ntm.radiation.rads", rads).formatted(Formatting.RED);
