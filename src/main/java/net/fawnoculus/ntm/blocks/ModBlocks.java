...
public class ModBlocks {
  ...
  public static final Block COAL_COKE_BLOCK = register("coal_coke_block", Block::new, STONE_SETTINGS);
  ...
  public static final Block PETROLEUM_COKE_BLOCK = register("petroleum_coke_block", Block::new, STONE_SETTINGS);
  public static final Block PLUTONIUM_BLOCK = register("plutonium_block", Block::new, STONE_SETTINGS);
  public static final Block PLUTONIUM_FUEL_BLOCK = register("plutonium_fuel_block", Block::new, STONE_SETTINGS);
