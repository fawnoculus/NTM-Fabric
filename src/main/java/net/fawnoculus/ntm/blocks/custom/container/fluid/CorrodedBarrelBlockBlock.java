...
public class CorrodedBarrelBlockBlock extends BlockWithEntity {
  public CorrodedBarrelBlockBlock(Settings settings, long maxMB) {
    super(settings);

    this.MAX_FLUID = maxMB;
  }
  // Extra Constructor for the Codec
  private CorrodedBarrelBlockBlock(Settings settings) {
    this(settings, 0);
  }
  ...
  protected MapCodec<? extends BlockWithEntity> getCodec() {
    return createCodec(CorrodedBarrelBlockBlock::new);
  }
