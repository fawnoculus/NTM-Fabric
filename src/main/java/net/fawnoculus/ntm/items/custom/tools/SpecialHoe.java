...
public class SpecialHoe extends HoeItem implements SpecialTool {
  ...
  public SpecialHoe addAbility(ItemAbility ability) {
    abilities.add(ability);
    return this;
  }
  
  public SpecialHoe addModifier(ItemModifier modifier) {
    modifiers.add(modifier);
    return this;
  }
  
  @Override
  public SpecialHoe canBreakDepthRock() {
