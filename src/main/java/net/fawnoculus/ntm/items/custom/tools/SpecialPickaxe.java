...
public class SpecialPickaxe extends Item implements SpecialTool {
  public SpecialPickaxe(Settings settings, ToolMaterial material, float attackDamage, float attackSpeed) {
    super(settings.pickaxe(material, attackDamage, attackSpeed).component(ModDataComponentTypes.SELECTED_ABILITY_COMPONENT, -1));
  }
  ...
  public SpecialPickaxe addAbility(ItemAbility ability) {
    abilities.add(ability);
    return this;
  }
  
  public SpecialPickaxe addModifier(ItemModifier modifier) {
    modifiers.add(modifier);
    return this;
  }
  
  @Override
  public SpecialPickaxe canBreakDepthRock() {
