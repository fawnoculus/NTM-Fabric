...
public class SpecialShovel extends ShovelItem implements SpecialTool {
  ...
  public SpecialShovel addAbility(ItemAbility ability) {
    abilities.add(ability);
    return this;
  }
  
  public SpecialShovel addModifier(ItemModifier modifier) {
    modifiers.add(modifier);
    return this;
  }
  
  @Override
  public SpecialShovel canBreakDepthRock() {
