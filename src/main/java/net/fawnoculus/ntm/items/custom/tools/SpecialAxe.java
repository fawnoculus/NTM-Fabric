...
public class SpecialAxe extends AxeItem implements SpecialTool {
  ...
  public SpecialAxe addAbility(ItemAbility ability) {
    abilities.add(ability);
    return this;
  }
  
  public SpecialAxe addModifier(ItemModifier modifier) {
    modifiers.add(modifier);
    return this;
  }
  
  @Override
  public SpecialAxe canBreakDepthRock() {
