...
public class ModItemGroups {
  ...
  public static void initialize() {
    ...
    ItemGroupEvents.modifyEntriesEvent(RESOURCES_AND_PARTS_KEY).register(ItemGroup -> {
      ...
      ItemGroup.add(ModItems.CURIUM_242_INGOT);
      ItemGroup.add(ModItems.CURIUM_243_INGOT);
      ItemGroup.add(ModItems.CURIUM_244_INGOT);
      ItemGroup.add(ModItems.CURIUM_245_INGOT);
      ItemGroup.add(ModItems.CURIUM_246_INGOT);
      ItemGroup.add(ModItems.CURIUM_247_INGOT);
      ItemGroup.add(ModItems.CURIUM_FUEL_INGOT);
      ItemGroup.add(ModItems.REACTOR_GRADE_CURIUM_INGOT);
      ItemGroup.add(ModItems.BERKELIUM_247_INGOT);
      ItemGroup.add(ModItems.CALIFORNIUM_251_INGOT);
      ItemGroup.add(ModItems.CALIFORNIUM_252_INGOT);
      ItemGroup.add(ModItems.EINSTEINIUM_253_INGOT);
      ItemGroup.add(ModItems.EINSTEINIUM_255_INGOT);
      ...
      ItemGroup.add(ModItems.NICKEL_INGOT);
      ItemGroup.add(ModItems.RED_COPPER_INGOT);
      ItemGroup.add(ModItems.ADVANCED_ALLOY_INGOT);
      ItemGroup.add(ModItems.ZINC_INGOT);
      ItemGroup.add(ModItems.GALLIUM_INGOT);
      ItemGroup.add(ModItems.GALLIUM_ARSENIDE_INGOT);
      ItemGroup.add(ModItems.TECHTACTIUM_INGOT);
      ItemGroup.add(ModItems.TECHTACTIUM_ARSENIDE_INGOT);
      ItemGroup.add(ModItems.PLATINIUM_INGOT);
      ItemGroup.add(ModItems.IRIDIUM_INGOT);
      ItemGroup.add(ModItems.PALLADIUM_INGOT);
      ItemGroup.add(ModItems.STEEL_INGOT);
      ItemGroup.add(ModItems.STAINLESS_STEEL_INGOT);
      ...
      ItemGroup.add(ModItems.VULCANITE_INGOT);
      ...
      ItemGroup.add(ModItems.GWENIUM_INGOT);
      ItemGroup.add(ModItems.HAFNIUM_INGOT);
