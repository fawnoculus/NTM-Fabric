  ...
  public interface ExtraType {
    ...
    record ItemOption() implements Option.ExtraType {
      public boolean isValid(String string) {
        if (Registries.ITEM.getDefaultEntry().isEmpty())
          throw new IllegalStateException("Registries.ITEM doesn't have a default value");
    ...
    record BlockOption() implements Option.ExtraType {
      public boolean isValid(String string) {
        if (Registries.BLOCK.getDefaultEntry().isEmpty())
          throw new IllegalStateException("Registries.BLOCK doesn't have a default value");
