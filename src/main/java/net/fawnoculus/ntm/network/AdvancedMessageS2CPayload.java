...
public record AdvancedMessageS2CPayload(AdvancedMessage message) implements CustomPayload {
  public static final Identifier BLOCK_POS_PAYLOAD_ID = NTM.id("advanced_message");
  public static final CustomPayload.Id<AdvancedMessageS2CPayload> ID = new CustomPayload.Id<>(BLOCK_POS_PAYLOAD_ID);
